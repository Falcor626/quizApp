...
const displayImage = document.getElementById('dcq')
...
function revealQ(question){
    ...
    if (question.question === ' Who is this Superhero?') {
...
const questions = [
    {
        question: ' Which comic book writer created the superhero Spider-Man?',
        answers: [
    ...
    {
        question: ' How many MCU (Marvel Cinematic Universe) movies are released as of March 2024?',
        answers: [
    ...
    {
        question: ' Which Robin died at the hands of the Joker?',
        answers: [
            {text: 'Jason Todd', correct: true},
    ...
    },
    {
        ...
        answers: [
            {text: 'The Question', correct: true},
